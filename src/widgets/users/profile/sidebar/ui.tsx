...
export const ProfileSidebar = ({ tab, setTab, isOwnProfile }: ProfileSidebarProps) => {
  return (
    <div className="flex flex-col gap-1 rounded-md border border-white/10 bg-black/60 p-1 text-xs">
      <div className="px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.26em] text-zinc-500">Профіль</div>
