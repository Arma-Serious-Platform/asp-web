...
export const Footer = () => (
  <footer className="mt-auto flex items-center justify-center border-t border-white/10 bg-black/80 py-4">
    <div className="container flex w-full items-center justify-between gap-4 px-4 text-xs text-zinc-300 max-xl:flex-col max-xl:text-center">
      <div className="flex flex-col gap-1">
        ...
        <span className="font-light text-xs">v{process.env.NEXT_PUBLIC_APP_VERSION}</span>
      </div>
