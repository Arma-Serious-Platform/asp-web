...
export class CreateUpdateMissionVersionState {
  constructor() {
    ...
    try {
      ...
      if (version) {
        ...
        const updateDto: UpdateMissionVersionDto = {
          ...
          friendlyScreenshots:
            data.enableFriendlySide && data.friendlyScreenshots.length > 0 ? data.friendlyScreenshots : undefined,
          ...
          removeFriendlyScreenshotIds:
            data.removeFriendlyScreenshotIds.length > 0 ? data.removeFriendlyScreenshotIds : undefined,
          inGameTime,
          weather,
          changelog: data.changelog,
          ...(friendlyPayload ? friendlyPayload : hadFriendly ? { clearFriendlySide: true } : {}),
        };
        ...
        await missionsApi.updateMissionVersion(missionId, version.id, updateDto);
