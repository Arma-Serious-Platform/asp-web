...
export const MissionVersionCard: FC<MissionVersionCardProps> = ({
  ...
  const sideLabels = MissionModel.getMissionSideRoleLabels(missionObjective);
  ...
  } = MissionModel.resolveUniformScreenshots(version);
                ...
                {[
                  ...
                  .map(status => (
                    <Button
                      ...
                      <CheckCircleIcon className={cn('size-4', MissionModel.statusTextColors[status])} />
