...
import { manageTwoFactorState, ManageTwoFactorState } from '../state/manage-two-factor.state';
import { getDisableTwoFactorFieldErrors } from '@/shared/lib/two-factor-payload';

const ManageTwoFactor: FC<{
  model?: ManageTwoFactorState;
  onStatusChange?: (enabled: boolean) => void;
}> = observer(({ model = manageTwoFactorState, onStatusChange }) => {
