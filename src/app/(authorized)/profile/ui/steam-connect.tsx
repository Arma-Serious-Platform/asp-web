...
import { DisconnectSteamState } from '../state/disconnect-steam.state';
import { DisconnectSteamModal } from './disconnect-steam';
...
const ProfileSteamConnect: FC<{
  user: User | null;
  disconnectModel: DisconnectSteamState;
  onChanged?: () => void;
      ...
      {user.steamId ? (
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          <Button
            ...
            onClick={() => {
              window.location.href = usersApi.getSteamLoginUrl();
            }}>
