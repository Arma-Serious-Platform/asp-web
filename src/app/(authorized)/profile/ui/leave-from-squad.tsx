...
import { LeaveFromSquadState, leaveFromSquadState } from '../state/leave-from-squad.state';

const LeaveFromSquadModal: FC<{
  model?: LeaveFromSquadState;
  onLeaveSuccess?: () => void;
}> = observer(({ model = leaveFromSquadState, onLeaveSuccess }) => {
