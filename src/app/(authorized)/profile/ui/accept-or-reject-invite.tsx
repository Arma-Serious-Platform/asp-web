...
import { AcceptOrRejectInviteState, acceptOrRejectInviteState } from '../state/accept-or-reject-invite.state';
...
export const SquadInviteList: FC<{
  ...
  onAccept?: (invitation: SquadInvitation) => void | Promise<void>;
  onReject?: (invitation: SquadInvitation) => void | Promise<void>;
}> = observer(({ invitations, model = acceptOrRejectInviteState, onAccept, onReject }) => {
