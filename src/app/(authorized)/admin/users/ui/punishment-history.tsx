...
import { PunishmentHistoryState, punishmentHistoryState } from '../state/punishment-history.state';
...
const PunishmentHistoryModal: FC<
  PropsWithChildren<{
    model?: PunishmentHistoryState;
    onWarningRemoved?: (warning: UserWarning) => void;
  }>
> = observer(({ model = punishmentHistoryState, children, onWarningRemoved }) => {
